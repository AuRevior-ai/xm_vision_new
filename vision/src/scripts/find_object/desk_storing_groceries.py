...
yolo = YOLO("/home/xiaomeng/catkin_ws/src/xm_vision/src/scripts/find_object/storebest.pt")
def DeskObject2(name, color_image, transformed_depth_point_cloud, fx, fy , real_y, flag):
    print(transformed_depth_point_cloud.shape)
    def get_coordinates(class_id, frame,  fy, flag):
        for result in results:
            for box in result.boxes:
                if box.cls[0] == class_id:
                    ...
                    cv2.putText(frame,f'{putname},{putclass}', (x1,y1-10),cv2.FONT_HERSHEY_SIMPLEX, 0.9 , (0,255,0), 2)
    ...
    # 尝试找到指定的物品
    coordinates_1,coordinates_2,coordinates_3,y = get_coordinates(name, color_image, real_y, flag)
    if coordinates_1:
        return name, coordinates_1, coordinates_2, coordinates_3, y,color_image
