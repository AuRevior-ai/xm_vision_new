...
yolo = YOLO("/home/xiaomeng/catkin_ws/src/xm_vision/src/scripts/find_object/breakfast_white.pt")
def DeskObject(name, color_image, transformed_depth_point_cloud, fx, fy, flag):
